...
function setHeaderVisibility(){
	if (head){
		...
		document.getElementById("r/diepio").style.visibility = "hidden"
		document.getElementById("r/dsm").style.visibility = "hidden"
		document.getElementById("Snoo").style.visibility = "hidden"
	} else {
		head = true
		...
		document.getElementById("r/diepio").style.visibility = "visible"
		document.getElementById("r/dsm").style.visibility = "visible"
		document.getElementById("Snoo").style.visibility = "visible"
	};
};
